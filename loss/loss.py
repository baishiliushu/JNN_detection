...
def build_target_cls(output, gt_data, H, W):
    """
    Build the training target for output tensor
    ...
    gt_boxes_batch -- tensor of shape (B, N, 4), ground truclasses_gt:th boxes, normalized values
                       (x1, y1, x2, y2) range 0~1
...
def yolo_loss_cls(output, target):
    """
    Build yolo loss
