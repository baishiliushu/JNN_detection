...
def parse_args():
    ...
    #
    parser.add_argument("--model_path", type=str, default="check_points/model_best.pt",
                        help="path to model file coco_voc199epoch-416 e60-rubby-16wjpg-448 e70-voc-60-448/")
    ...
    parser.add_argument("--q_name", type=str, default="udisk", help="name of object")
    ...
    parser.add_argument("--rst_path", type=str,
                        default='/home/leon/opt-exprements/expments/data_test/template_match/backs/cc_448_0227',
